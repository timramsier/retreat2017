...
[ -e "/ask/data/www/reports/snowboarding.csv" ] && rm "/ask/data/www/reports/snowboarding.csv"
...
echo "Output File: /ask/data/www/reports/snowboarding.csv"
echo ""
cp /var/lib/mysql-files/snowboarding.temp.csv "/ask/data/www/reports/snowboarding.csv"
