...
[ -e "/var/app/current/reports/skiing.csv" ] && rm "/var/app/current/reports/skiing.csv"
...
echo "Output File: /var/app/current/reports/skiing.csv"
echo ""

cp /var/lib/mysql-files/skiing.temp.csv "/var/app/current/reports/skiing.csv"
