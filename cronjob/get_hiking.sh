...
[ -e "/var/app/current/reports/hiking.csv" ] && rm "/var/app/current/reports/hiking.csv"
...
echo "Output File: /var/app/current/reports/hiking.csv"
echo ""
cp /var/lib/mysql-files/hiking.temp.csv "/var/app/current/reports/hiking.csv"
